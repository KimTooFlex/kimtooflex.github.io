...
okf:
  ...
  generated_at: "2026-08-28T14:53:35.650Z"
---
---
title: "KimTools / Controls / SvgCanvas"
description: "A high-performance SVG canvas with a full templating engine supporting model binding, loops, conditionals, show/hide, processing instructions, and CSS SmartFormat variables."
...
== side
![kt-svg-canvas-light](/assets/images/screenshots/kt-svg-canvas/kt-svg-canvas-light.png?v=639235348439107254){ .light .snapshot} ![kt-svg-canvas-dark](/assets/images/screenshots/kt-svg-canvas/kt-svg-canvas-dark.png?v=639235348439107254){.dark .snapshot}
:::
...
string[] icons = { IconHome, IconUser, IconHeart, IconGear, IconBell };
KtColor[] colors = { KtColor.PRIMARY, KtColor.INFO, KtColor.ERROR, KtColor.CONTENT, KtColor.WARNING };
	
for (int i = 0; i < icons.Length; i++)
{
    int dim = (int)((panel.Height - panel.Padding.Vertical) * 0.8);
...
![svg-icon-row-light](/assets/images/screenshots/kt-svg-canvas/svg-icon-row-light.png?v=639235348474064273){ .light .snapshot} ![svg-icon-row-dark](/assets/images/screenshots/kt-svg-canvas/svg-icon-row-dark.png?v=639235348474064273){.dark .snapshot}

== tab "Light" icon:sun
![svg-icon-row-light](/assets/images/screenshots/kt-svg-canvas/svg-icon-row-light.png?v=639235348474038877){  .snapshot}

== tab "Dark" icon:moon
![svg-icon-row-dark](/assets/images/screenshots/kt-svg-canvas/svg-icon-row-dark.png?v=639235348474038877){ .snapshot}
...
::: tabs
== tab "Auto" icon:app-window
![svg-themed-light](/assets/images/screenshots/kt-svg-canvas/svg-themed-light.png?v=639235348498376833){ .light .snapshot} ![svg-themed-dark](/assets/images/screenshots/kt-svg-canvas/svg-themed-dark.png?v=639235348498376833){.dark .snapshot}

== tab "Light" icon:sun
![svg-themed-light](/assets/images/screenshots/kt-svg-canvas/svg-themed-light.png?v=639235348498364462){  .snapshot}

== tab "Dark" icon:moon
![svg-themed-dark](/assets/images/screenshots/kt-svg-canvas/svg-themed-dark.png?v=639235348498364462){ .snapshot}

:::
:::

::: hero layout:split glow:true
## Model-Bound Geometry & Text
Leverage the `Model` dictionary to inject dynamic values into SVG templates. Reference keys like `{status}` and `{progress}` inside the SVG markup; the compiler substitutes them at render time. Here the bar width is driven by `{progress}%`, stretching relative to the canvas. Ideal for progress badges, counters, and live data overlays.
```csharp "🔴 🟡 🟢"
var panel = new FlowLayoutPanel
{
    Width = 420,
...
canvas.Templates.Add(new KtSvgTemplate(canvas.Templates)
{
    ...
    Svg =
        ...
        @"<rect x=""0"" y=""30%"" width=""{progress}%"" height=""40%"" rx=""4"" fill=""currentColor"" opacity=""0.9""/>" +
        @"<text x=""50%"" y=""50%"" dominant-baseline=""middle"" text-anchor=""middle"" font-size=""14"" fill=""white"">{status}</text>" +
        @"</svg>"
});
	
canvas.Model["status"] = "Uploading...";
canvas.Model["progress"] = 65;
canvas.Render();
...
::: tabs
== tab "Auto" icon:app-window
![svg-model-bound-light](/assets/images/screenshots/kt-svg-canvas/svg-model-bound-light.png?v=639235348521282182){ .light .snapshot} ![svg-model-bound-dark](/assets/images/screenshots/kt-svg-canvas/svg-model-bound-dark.png?v=639235348521282182){.dark .snapshot}

== tab "Light" icon:sun
![svg-model-bound-light](/assets/images/screenshots/kt-svg-canvas/svg-model-bound-light.png?v=639235348521272039){  .snapshot}

== tab "Dark" icon:moon
![svg-model-bound-dark](/assets/images/screenshots/kt-svg-canvas/svg-model-bound-dark.png?v=639235348521272039){ .snapshot}
...
var canvas = new KtSvgCanvas
{
    Width = (int)((panel.Width - panel.Padding.Horizontal) * 0.5),
    Height = panel.Height - panel.Padding.Vertical,
    Margin = new Padding(0, 10, 0, 10),
    BackColor = KtColor.BASE_2,
...
::: tabs
== tab "Auto" icon:app-window
![svg-conditional-light](/assets/images/screenshots/kt-svg-canvas/svg-conditional-light.png?v=639235348543778045){ .light .snapshot} ![svg-conditional-dark](/assets/images/screenshots/kt-svg-canvas/svg-conditional-dark.png?v=639235348543778045){.dark .snapshot}

== tab "Light" icon:sun
![svg-conditional-light](/assets/images/screenshots/kt-svg-canvas/svg-conditional-light.png?v=639235348543778045){  .snapshot}

== tab "Dark" icon:moon
![svg-conditional-dark](/assets/images/screenshots/kt-svg-canvas/svg-conditional-dark.png?v=639235348543778045){ .snapshot}
...
::: tabs
== tab "Auto" icon:app-window
![svg-loop-light](/assets/images/screenshots/kt-svg-canvas/svg-loop-light.png?v=639235348566344818){ .light .snapshot} ![svg-loop-dark](/assets/images/screenshots/kt-svg-canvas/svg-loop-dark.png?v=639235348566344818){.dark .snapshot}

== tab "Light" icon:sun
![svg-loop-light](/assets/images/screenshots/kt-svg-canvas/svg-loop-light.png?v=639235348566344818){  .snapshot}

== tab "Dark" icon:moon
![svg-loop-dark](/assets/images/screenshots/kt-svg-canvas/svg-loop-dark.png?v=639235348566344818){ .snapshot}
...
::: tabs
== tab "Auto" icon:app-window
![svg-show-hide-light](/assets/images/screenshots/kt-svg-canvas/svg-show-hide-light.png?v=639235348588988347){ .light .snapshot} ![svg-show-hide-dark](/assets/images/screenshots/kt-svg-canvas/svg-show-hide-dark.png?v=639235348588988347){.dark .snapshot}

== tab "Light" icon:sun
![svg-show-hide-light](/assets/images/screenshots/kt-svg-canvas/svg-show-hide-light.png?v=639235348588988347){  .snapshot}

== tab "Dark" icon:moon
![svg-show-hide-dark](/assets/images/screenshots/kt-svg-canvas/svg-show-hide-dark.png?v=639235348588988347){ .snapshot}
...
::: tabs
== tab "Auto" icon:app-window
![svg-processing-light](/assets/images/screenshots/kt-svg-canvas/svg-processing-light.png?v=639235348611781498){ .light .snapshot} ![svg-processing-dark](/assets/images/screenshots/kt-svg-canvas/svg-processing-dark.png?v=639235348611781498){.dark .snapshot}

== tab "Light" icon:sun
![svg-processing-light](/assets/images/screenshots/kt-svg-canvas/svg-processing-light.png?v=639235348611781498){  .snapshot}

== tab "Dark" icon:moon
![svg-processing-dark](/assets/images/screenshots/kt-svg-canvas/svg-processing-dark.png?v=639235348611781498){ .snapshot}
...
canvas.Templates.Add(new KtSvgTemplate(canvas.Templates)
{
    ...
    Svg =
        ...
        @"<text x=""50%"" y=""50%"" dominant-baseline=""middle"" text-anchor=""middle"" font-size=""14"" fill=""white"">{label}</text>" +
        @"</svg>"
});
...
::: tabs
== tab "Auto" icon:app-window
![svg-css-smart-light](/assets/images/screenshots/kt-svg-canvas/svg-css-smart-light.png?v=639235348634376327){ .light .snapshot} ![svg-css-smart-dark](/assets/images/screenshots/kt-svg-canvas/svg-css-smart-dark.png?v=639235348634376327){.dark .snapshot}

== tab "Light" icon:sun
![svg-css-smart-light](/assets/images/screenshots/kt-svg-canvas/svg-css-smart-light.png?v=639235348634365413){  .snapshot}

== tab "Dark" icon:moon
![svg-css-smart-dark](/assets/images/screenshots/kt-svg-canvas/svg-css-smart-dark.png?v=639235348634376327){ .snapshot}
...
canvas.Templates.Add(new KtSvgTemplate(canvas.Templates)
{
    ...
    Svg =
        ...
        @"<text x=""{x + 15}%"" y=""25%"" text-anchor=""middle"" font-size=""10"" fill=""currentColor"">{name}</text>" +
        @"<rect x=""{x + 5}%"" y=""{90 - val}%"" width=""20%"" height=""{val}%"" fill=""currentColor"" opacity=""0.8""/>" +
        @"<text x=""{x + 15}%"" y=""95%"" text-anchor=""middle"" font-size=""10"" fill=""currentColor"">{val}%</text>" +
        @"<text x=""{x + 15}%"" y=""40%"" text-anchor=""middle"" font-size=""9"" fill=""currentColor"" x:show=""{val > 80}"">HIGH</text>" +
        @"</g>" +
        @"</svg>"
});
...
::: tabs
== tab "Auto" icon:app-window
![svg-advanced-light](/assets/images/screenshots/kt-svg-canvas/svg-advanced-light.png?v=639235348657412089){ .light .snapshot} ![svg-advanced-dark](/assets/images/screenshots/kt-svg-canvas/svg-advanced-dark.png?v=639235348657412089){.dark .snapshot}

== tab "Light" icon:sun
![svg-advanced-light](/assets/images/screenshots/kt-svg-canvas/svg-advanced-light.png?v=639235348657412089){  .snapshot}

== tab "Dark" icon:moon
![svg-advanced-dark](/assets/images/screenshots/kt-svg-canvas/svg-advanced-dark.png?v=639235348657412089){ .snapshot}
